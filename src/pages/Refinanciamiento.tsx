...
// Formatear porcentaje mientras se escribe
const formatearPorcentaje = (valor: string): string => {
  const limpio = valor.replace(/[^\d]/g, "");
  if (!limpio) return "";
  const parteEntera = limpio.slice(0, -2) || "0";
  const parteDecimal = limpio.slice(-2);
          ...
          <div className="venta-form-grid">
            <div className="venta-form-group">
              ...
              <input 
                id="saldo-actual" 
                className="venta-form-input" 
                value={operacion.saldoActual}
                onChange={(e) => setOperacion({...operacion, saldoActual: formatearMoneda(e.target.value)})}
              />
            </div>
            <div className="venta-form-group">
              ...
              <input 
                id="monto-aportado" 
                className="venta-form-input" 
                value={operacion.montoAportado}
                onChange={(e) => setOperacion({...operacion, montoAportado: formatearMoneda(e.target.value)})}
              />
            </div>
            <div className="venta-form-group">
            ...
            <div className="venta-form-group">
              <label htmlFor="venta-cuotas">Monto del bono o Financiamiento</label>
              <input 
                id="venta-cuotas" 
                className="venta-form-input" 
                value={operacion.montoBono}
                onChange={(e) => setOperacion({...operacion, montoBono: e.target.value})}
              />
            </div>
            <div className="venta-form-group">
              ...
              <input 
                ...
                className="venta-form-input" 
                value={operacion.numeroCuota}
                onChange={(e) => setOperacion({...operacion, numeroCuota:(e.target.value)})}
              />
            </div>
            <div className="venta-form-group">
            ...
            <div className="venta-modal-pdf-body">
              <div className="venta-contenido-vista-previa">
                ...
                <div className="venta-pdf-placeholder">
                  ...
                  <p>Monto del Bono: {operacion.montoBono}</p>
